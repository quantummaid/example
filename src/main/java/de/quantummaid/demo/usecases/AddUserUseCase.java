...
import de.quantummaid.demo.domain.UserAlreadyExistsException;
...
public final class AddUserUseCase {
    ...
    public void addUser(final AddUserRequest addUserRequest) throws UserAlreadyExistsException {
        System.out.println("currentUser = " + addUserRequest.currentUser);
        validateNotNull(addUserRequest, "addUserRequest");
        userRepository.add(addUserRequest.user);
    }
}
