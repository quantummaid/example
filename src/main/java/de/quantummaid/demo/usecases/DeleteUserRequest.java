...
public final class DeleteUserRequest {
    ...
    public static DeleteUserRequest deserialize(final AuthenticatedUser currentUser,
                                                final UserIdentifier userIdentifier) {
        validateNotNull(currentUser, "currentUser");
        validateNotNull(userIdentifier, "userIdentifier");
        return new DeleteUserRequest(currentUser, userIdentifier);
    }
}
