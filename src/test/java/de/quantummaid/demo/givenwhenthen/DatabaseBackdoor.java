...
public final class DatabaseBackdoor {
    private final UserRepository userRepository;

    public static DatabaseBackdoor databaseBackdoor() {
        return new DatabaseBackdoor(USER_REPOSITORY);
    }

    public void reset() {
        userRepository.list().forEach(user -> {
            try {
                userRepository.delete(user.userIdentifier);
